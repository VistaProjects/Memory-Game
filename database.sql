...
INSERT INTO `vraag` (`id`, `naam`, `antwoord_a`, `antwoord_b`, `antwoord_c`, `antwoord_d`, `juiste_antwoord`) VALUES ('', 'Wat is de betekenis van VPN?', 'Virtual Private Network', 'Virtual Private Node', 'Virtualisation Primary Network', 'Virtual Plex Node', 'error messaVirtual Private Networkge packets for problemen met IP packets');
INSERT INTO `vraag` (`id`, `naam`, `antwoord_a`, `antwoord_b`, `antwoord_c`, `antwoord_d`, `juiste_antwoord`) VALUES ('', 'Wat doet DNS?', 'Resolve domain name naar ip-addres', 'Zoekt en indext ip-addressen van websites', 'zoekmachine voor domein namen', 'website domein naam beveiligen', 'Resolve domain name naar ip-addres');
